...
import os
import numpy as np
import dat_events_tools as dat
import npy_events_tools as npy_format
...
if __name__ == "__main__":
    path = "data/detection_dataset_duration_60s_ratio_1.0/train/18-03-29_12-30-10_122500000_182500000_bbox.npy"
    labels = PSEELoader(path)
    all_labels = labels.load_n_events(labels.event_count())
    t = all_labels["t"]
    print(all_labels)
